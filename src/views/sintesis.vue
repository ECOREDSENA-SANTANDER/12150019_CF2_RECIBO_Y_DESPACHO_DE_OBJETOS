  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center
      .col-lg-12.mb-5.bgs.p-4.brad
        figure
          img(src="@/assets/curso/sintesis.png", alt="Diagrama de flujo sobre la gestión y condiciones de devolución de mercancías y objetos, que incluye aspectos como devoluciones, especificación de productos, políticas de devolución, acuerdos comerciales, documentación, informes y atención al cliente.")
      .col-auto
